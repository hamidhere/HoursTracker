...
//  pisiffik_ios
//
//  Created by Hamid Raza on 27/05/2022.
...
extension String {
    static let hoursTracker: String = "Hours Tracker"
}
...
//        guard let alertVC = R.storyboard.authSB.storeHelpVC() else {return}
//        alertVC.currentTitle = title
...
extension String {
    ...
    func getPurchaseDate(incomingFormat: String, outGoingFormat: String) -> String{
        let dateFormatter = DateFormatter()
        dateFormatter.timeZone = TimeZone(abbreviation: "UTC")
        dateFormatter.dateFormat = incomingFormat
